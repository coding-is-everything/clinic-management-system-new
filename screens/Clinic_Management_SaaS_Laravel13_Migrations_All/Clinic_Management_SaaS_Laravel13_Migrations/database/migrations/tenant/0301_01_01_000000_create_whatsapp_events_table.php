...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('whatsapp_events', function (Blueprint $table) {
            ...
            $table->unique(['public_id'], 'uq_whatsapp_events_public_id');
            $table->index(['created_at'], 'idx_whatsapp_events_created_at');
            $table->index(['updated_at'], 'idx_whatsapp_events_updated_at');
        });
    }
