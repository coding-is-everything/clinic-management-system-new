...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('inventory_kpis', function (Blueprint $table) {
            ...
            $table->unique(['public_id'], 'uq_inventory_kpis_public_id');
            $table->index(['created_at'], 'idx_inventory_kpis_created_at');
            $table->index(['updated_at'], 'idx_inventory_kpis_updated_at');
            $table->index(['metric_date'], 'idx_inventory_kpis_metric_date');
        });
    }
