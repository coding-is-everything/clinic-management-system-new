...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('api_key_events', function (Blueprint $table) {
            ...
            $table->unique(['public_id'], 'uq_api_key_events_public_id');
            $table->index(['created_at'], 'idx_api_key_events_created_at');
            $table->index(['updated_at'], 'idx_api_key_events_updated_at');
        });
    }
