...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('localization_settings', function (Blueprint $table) {
            ...
            $table->unique(['public_id'], 'uq_localization_settings_public_id');
            $table->index(['created_at'], 'idx_localization_settings_created_at');
            $table->index(['updated_at'], 'idx_localization_settings_updated_at');
        });
    }
