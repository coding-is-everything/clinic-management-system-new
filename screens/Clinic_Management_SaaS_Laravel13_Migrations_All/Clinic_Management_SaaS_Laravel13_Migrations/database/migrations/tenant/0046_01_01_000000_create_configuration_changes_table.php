...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('configuration_changes', function (Blueprint $table) {
            ...
            $table->unique(['public_id'], 'uq_configuration_changes_public_id');
            $table->index(['created_at'], 'idx_configuration_changes_created_at');
            $table->index(['updated_at'], 'idx_configuration_changes_updated_at');
        });
    }
