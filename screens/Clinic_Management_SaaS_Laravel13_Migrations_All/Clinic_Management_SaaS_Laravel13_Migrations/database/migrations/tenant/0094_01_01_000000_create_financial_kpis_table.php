...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('financial_kpis', function (Blueprint $table) {
            ...
            $table->unique(['public_id'], 'uq_financial_kpis_public_id');
            $table->index(['created_at'], 'idx_financial_kpis_created_at');
            $table->index(['updated_at'], 'idx_financial_kpis_updated_at');
            $table->index(['metric_date'], 'idx_financial_kpis_metric_date');
        });
    }
